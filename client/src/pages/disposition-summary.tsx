...
export default function DispositionSummaryPage() {
  ...
  const generateSummaryText = () => {
    ...
    if (caseData.disposition) {
      summary += `FINAL DECISION: ${getDispositionLabel(caseData.disposition)}\n\n`;
    }
    ...
    if (dischargeType && caseData.patientEducation) {
      summary += `PATIENT EDUCATION:\n${"-".repeat(30)}\n${formatField(caseData.patientEducation)}\n\n`;
    }
    
    if (dischargeType && caseData.treatmentRedFlags) {
      ...
      <div className="p-6 pb-24">
        <Card className="border-none shadow-lg bg-white dark:bg-slate-900 mb-6 overflow-hidden">
          ...
          <CardContent className="space-y-6">
                ...
                <div className="text-sm text-foreground bg-slate-50 dark:bg-slate-800/50 rounded-lg p-3">
                  {parseAIContent(caseData.plan).length > 1 ? (
                    <ul className="list-disc list-outside space-y-1.5 pl-4">
                      {parseAIContent(caseData.plan).map((item, i) => (
            ...
            {isDischargeType(caseData.disposition) && caseData.patientEducation && (
              <div>
            ...
            {isDischargeType(caseData.disposition) && caseData.treatmentRedFlags && (
              <div>
            ...
            {isDischargeType(caseData.disposition) && (
              <div>
